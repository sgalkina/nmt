...
#SBATCH --job-name=moflow-training  # Name of the job
...
#SBATCH --time=2-00:00:00           # Expected runtime (max)
...
"""
conda create --name moflow 
conda activate moflow
conda install pytorch torchvision -c pytorch 
conda install -c conda-forge rdkit=2023.09.5 -n moflow
conda install -c conda-forge orderedset
